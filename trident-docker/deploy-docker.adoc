...
summary: O Astra Trident para Docker fornece integração direta ao ecossistema Docker para plataformas de storage da NetApp, bem como ao Cloud Volumes Service na AWS. Ele dá suporte ao provisionamento e gerenciamento de recursos de storage da plataforma de storage para hosts Docker, com uma estrutura para adicionar plataformas adicionais no futuro. 
---
...
O Astra Trident para Docker fornece integração direta ao ecossistema Docker para plataformas de storage da NetApp, bem como ao Cloud Volumes Service na AWS. Ele dá suporte ao provisionamento e gerenciamento de recursos de storage da plataforma de storage para hosts Docker, com uma estrutura para adicionar plataformas adicionais no futuro.
