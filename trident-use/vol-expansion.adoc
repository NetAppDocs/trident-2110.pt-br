...
O Astra Trident dá suporte à expansão de volume para PVS NFS provisionados em `ontap-nas` `ontap-nas-economy` , , , `ontap-nas-flexgroup`, , `aws-cvs` `gcp-cvs` e `azure-netapp-files` backends.
