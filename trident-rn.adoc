...
== Novidades em 21.10.1

A NetApp está continuamente melhorando e aprimorando seus produtos e serviços. Aqui estão alguns dos recursos e funcionalidades mais recentes disponíveis no Astra Trident.

Para versões anteriores, https://docs.netapp.com/us-en/trident/earlier-versions.html["Versões Ealier da documentação"]consulte .



=== Mudanças desde o Astra Trident 21.10.0
...
=== Mudanças desde o Astra Trident 21,07
